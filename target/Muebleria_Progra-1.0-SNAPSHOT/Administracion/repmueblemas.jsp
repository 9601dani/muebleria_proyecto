<%-- 
    Document   : repmueblemas
    Created on : 4/09/2021, 01:42:53
    Author     : daniel
--%>
    ...
    <body>
        <h3 class="text-center">Reporte Mueble Mas Vendido</h3>
                <%
                   ...
                   rs=smy.executeQuery("SELECT me.nombre_mueble, COUNT(me.nombre_mueble) AS Cantidad FROM factura as f INNER JOIN mueble_ensamblado as me WHERE fecha_compra BETWEEN '2000-02-01' AND '2080-03-01' AND f.id_mueble_ensamblado= me.id_mueble_ensamblado GROUP BY me.nombre_mueble ORDER BY Cantidad DESC LIMIT 1"); 
                   String nom="";
                   String f1="";
                   String f2="";
                   String cant="1";
