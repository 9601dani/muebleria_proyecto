<%-- 
    Document   : consultafehcas
    Created on : 3/09/2021, 04:38:23
    Author     : daniel
--%>
    ...
    <body>
        <h3 class="text-center">Consulta de Muebles Creados</h3>
                <%
                   ...
                   rs=smy.executeQuery("SELECT m.id_mueble_ensamblado, m.fecha_ensamble, m.costo_fabricacion, m.usuario_nombre, m.nombre_mueble, e.nombre_estado FROM mueble_ensamblado as m INNER JOIN estado_mueble_ensamblado as e WHERE m.id_estado_mueble=e.id_estado_mueble_ensamblado"); 
                %>
