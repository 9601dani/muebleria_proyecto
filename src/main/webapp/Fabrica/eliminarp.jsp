...
<html>
    ...
    <body>
        ...
        <div class="container buscar">
            ...
            <form>
                ...
                <input class="btn btn-success" type="submit" value="Seleccionar para Eliminar">
                <br>
    ...
    <div class="container buscar">
        ...
        <div class="container">
            <form method="POST" action="/Muebleria_Progra/DPieza">
                <%                while (rs.next()) {
                %>
                ...
                <input class="form-control" type="text" name="textc" value="<%=rs.getBigDecimal("costo")%>" readonly>
                <br>
                <label type="text"> Cantidad</label>
                <input class="form-control" type="text" name="textca" value="<%=rs.getInt("cantidad")%>" readonly>
                <%}%>
                <div class="text-center">
                    <input type="submit" class="btn btn-primary" value="ELIMINAR"></a>
                </div>
            </form>
        </div>
