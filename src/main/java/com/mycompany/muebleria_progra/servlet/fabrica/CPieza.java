 ...
 * @author daniel
 */
public class CPieza extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         String pieza= request.getParameter("textp");
            ...
            mp.añadir(new Pieza(pieza, new BigDecimal(coston),Integer.parseInt(cantidad)));
        ...
        if(msg.equals("ok")){
            ...
            out.println("<t1>" + "Se añadio correctamente" + "</t1>");
            out.println("<br>");
            ...
            out.println("<br>");
            out.println("<body class=\"text-center\"  style=\"background-color: beige\">");
            out.println("<t1>" + "No se pudo añadir revisa los campos ingresados" + "</t1>");
            out.println("<br>");
